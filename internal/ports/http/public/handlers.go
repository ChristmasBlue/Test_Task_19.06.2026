...
func (s *Server) Register(c *gin.Context) {
	...
	user, err := s.service.CreateUser(ctx, req.Name, req.Password, req.Email)
	if err != nil {
...
func (s *Server) AddMember(c *gin.Context) {
	...
	err = s.service.AddMember(ctx, userID, teamID, req.InviteUserID)
	if err != nil {
	...
	c.JSON(http.StatusCreated, gin.H{"message": "success", "user_id": req.InviteUserID})
	return
}
...
func (s *Server) AddComment(c *gin.Context) {
	...
	err = s.service.AddComment(ctx, userID, taskID, req.Comment)
	if err != nil {
	...
	c.JSON(http.StatusCreated, gin.H{"message": "success", "task": req.Comment})
	return
}
...
func (s *Server) GetHistory(c *gin.Context) {
	...
	history, err := s.service.GetHistory(ctx, taskID)
	if err != nil {
